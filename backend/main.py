...
app = FastAPI(
    title="MatchPlay Hub 2",
    description="Multiplayer matchmaking with ranking, lobby, and stats tracking",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "MatchPlay Hub 2"}
